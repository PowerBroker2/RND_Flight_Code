...
const int COMMAND_PERIOD = 20; // ms
...
void setupControls()
{
  ...
  commandTimer.begin(COMMAND_PERIOD);
}
...
void sendCommands()
{
  ...
  {
    inputs.yaw      = I1_PulseLen;
    inputs.pitch    = reverse(I2_PulseLen);
    inputs.throttle = I3_PulseLen;
    inputs.roll     = I4_PulseLen;
    
    inputs.ec1 = I5_PulseLen;
    inputs.ec2 = I6_PulseLen;
    inputs.ec3 = I7_PulseLen;
    inputs.ec4 = I8_PulseLen;

    commandTransfer.sendDatum(inputs);
  }
}
